...
import 'package:todo_list_app/app/providers.dart';
import 'package:todo_list_app/app/user_providers.dart';
...
class _ProductListTileState extends ConsumerState<ProductListTile> {
  ...
  //   return FirestoreService(uid: toString()).updateTodo(todo);
  //   // return FirestoreService.addList(todo);
  // }
  ...
  //   return .toggleTodoStatus(Todo(formatedDate: formatedDate, title: title,isDone: todo.isDone));
  // }
   ...
   bool toggleTodoStatus(Todo todo) {
    ...
    // FirestoreService(uid: uid)
        ...
        Todo(formatedDate: todo.formatedDate, title: todo.title);
